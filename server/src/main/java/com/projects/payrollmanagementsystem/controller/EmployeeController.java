...
public class EmployeeController {
    ...
    @GetMapping("/spec")
    public ResponseEntity<List<EmployeeDTO>> getCustomersBySpecification(@RequestParam(value = "search") String search){
        return ResponseEntity.ok(employeeService.getEmployeesBySpecification(search));
