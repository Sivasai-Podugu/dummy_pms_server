...
@Generated(
    ...
    date = "2023-09-05T19:39:21+0530",
    comments = "version: 1.5.3.Final, compiler: javac, environment: Java 20.0.1 (Oracle Corporation)"
)
@Component
public class MapperImplementationImpl implements MapperImplementation {
    ...
    public EmployeeDTO map(Employee employee) {
        ...
        employeeDTO.setEarningsDTO( map( employee.getEarning() ) );
        employeeDTO.setDeductionsDTO( map( employee.getDeduction() ) );
